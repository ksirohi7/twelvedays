...
```{r unit testing}
usethis::use_test("pluralize_gift")
...
test_that("make_phrase", {
  expect_error(expect_match(make_phrase(12, "twelve", "giants", "jelloing", "", ""), "twelve giants jellowfing"))
})
...
test_that("sing_day", {
  expect_error(expect_equal(sing_day(xmas, 2, Adjective), "On the second day of Christmas, my true love gave to me,
               turtle,
               and NA ."))
